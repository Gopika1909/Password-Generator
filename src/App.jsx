  ...
  return (
    <>
      <section className='h-full'>
        ...
        <div className='absolute bottom-[5px] left-[7px] text-cyan-300 tracking-light font-mono'>🚀 Made by <a className='text-blue-500' target="_blank" href="https://murdock9803.github.io/Gopika-Portfolio/">Gopika Pasricha</a>, &#169; 2025</div>
      </section>
    </>
  )
}
